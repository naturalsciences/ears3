...
(
    id      bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY (START WITH 20005),
...
(
    ...
    cog_instr_id      character varying(50),
    cog_timestamp     timestamp with time zone,
    depth             double precision,
    depth_instr_id    character varying(50),
    depth_timestamp   timestamp with time zone,
    heading           double precision,
    heading_instr_id  character varying(50),
    heading_timestamp timestamp with time zone,
    lat               double precision,
    lat_instr_id      character varying(50),
    lat_timestamp     timestamp with time zone,
    lon               double precision,
    lon_instr_id      character varying(50),
    lon_timestamp     timestamp with time zone,
    sog               double precision,
    sog_instr_id      character varying(50),
    sog_timestamp     timestamp with time zone,
    sow               double precision,
    sow_instr_id      character varying(50),
    sow_timestamp     timestamp with time zone
);
...
(
    ...
    conductivity_instr_id       character varying(50),
    conductivity_timestamp      timestamp with time zone,
    raw_fluorometry             double precision,
    raw_fluorometry_instr_id    character varying(50),
    raw_fluorometry_timestamp   timestamp with time zone,
    salinity                    double precision,
    salinity_instr_id           character varying(50),
    salinity_timestamp          timestamp with time zone,
    sigmat                      double precision,
    sigmat_instr_id             character varying(50),
    sigmat_timestamp            timestamp with time zone,
    temperature                 double precision,
    temperature_instr_id        character varying(50),
    temperature_timestamp       timestamp with time zone
);
...
(
    ...
    atmospheric_pressure_instr_id         character varying(50),
    atmospheric_pressure_timestamp        timestamp with time zone,
    atmospheric_temperature               double precision,
    atmospheric_temperature_instr_id      character varying(50),
    atmospheric_temperature_timestamp     timestamp with time zone,
    humidity                              double precision,
    humidity_instr_id                     character varying(50),
    humidity_timestamp                    timestamp with time zone,
    solar_radiation                       double precision,
    solar_radiation_instr_id              character varying(50),
    solar_radiation_timestamp             timestamp with time zone,
    water_temperature                     double precision,
    water_temperature_instr_id            character varying(50),
    water_temperature_timestamp           timestamp with time zone,
    wind_direction                        double precision,
    wind_direction_instr_id               character varying(50),
    wind_direction_timestamp              timestamp with time zone,
    wind_speed_average                    double precision,
    wind_speed_average_instr_id           character varying(50),
    wind_speed_average_timestamp          timestamp with time zone,
    wind_speed_instantaneous              double precision,
    wind_speed_instantaneous_instr_id     character varying(50),
    wind_speed_instantaneous_timestamp    timestamp with time zone
);
...
ALTER TABLE event
    ADD CONSTRAINT event_unique UNIQUE (time_stamp, platform_id, program_id, action_id, process_id, tool_id,
                                        tool_category_id, actor_id, label);
ALTER TABLE tool
