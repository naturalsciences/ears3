...
public class EFCruisesTest {
    ...
    public static CruiseDTO createCruise(String identifier, String objectives, String start, String stop,
            String platform, String departureHarbour, String arrivalHarbour, String collateCentre, String PIFirst,
            String PILast, String PIEDMO, String seaArea) {
    ...
    public static ProgramDTO createProgram(String identifier, String description, String PIFirst, String PILast,
            String PIEDMO) {
        ProgramDTO p = new ProgramDTO();
    ...
    public static void postProgram(MockMvc mockMvc, ProgramDTO program, ObjectMapper objectMapper) throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.post("/api/program").contentType(MediaType.APPLICATION_JSON).content(json))
                // //.andDo(print())
    ...
    public static void postCruise(MockMvc mockMvc, CruiseDTO cruise, ObjectMapper objectMapper) throws Exception {
        ...
        mockMvc.perform(
                MockMvcRequestBuilders.post("/api/cruise").contentType(MediaType.APPLICATION_JSON).content(json))
                // //.andDo(print())
                .andExpect(status().isCreated())
                .andReturn();
    }
    ...
    public void testCreateEFCruises() throws Exception {
        ...
        ProgramDTO caringP = createProgram("CARING",
