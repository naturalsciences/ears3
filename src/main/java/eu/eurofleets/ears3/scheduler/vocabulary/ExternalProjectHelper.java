...
public class ExternalProjectHelper implements IExternalHelper<Project> {
    ...
    private String getList() {
        ...
        String url = "https://edmerp.seadatanet.org/webservices/edmerp/edmerp.asmx";
        ...
        return restClient.post()
                ...
                .header("SOAPAction", "http://seadatanet.maris2.nl/webservices/edmerp/get_list")
                        ...
                        /* for (Extent extent : dataIdInfo.getDataExt()) {
                            if (extent.getTempEle() != null) {
                                ...
                                if (value != null && value instanceof TempExtent) {
                                    ...
                                    if (tempExtent.getExTemp() != null
                                            && tempExtent.getExTemp().getTMPrimitive() != null
                                            && tempExtent.getExTemp().getTMPrimitive().getValue() != null && tempExtent
                                                    .getExTemp().getTMPrimitive().getValue().getTMPeriod() != null) {
                                        begin = tempExtent.getExTemp().getTMPrimitive().getValue().getTMPeriod()
                                                .getBegin();
